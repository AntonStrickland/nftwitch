...
contract NFTwitch is ChainlinkClient, Ownable {
  ...
  function demo(address _oracle, string _jobId, string _login) public
  {
    Chainlink.Request memory req = buildChainlinkRequest(stringToBytes32(_jobId), this, this.fulfillDemo.selector);
  ...
  function fulfillDemo(bytes32 _requestId, uint256 _follows)
    public
    recordChainlinkFulfillment(_requestId)
  {
    emit DemoFulfilled(_requestId, _follows);
    followerCount = _follows;
  }
